...
<body class="font-sans antialiased bg-gray-900 text-white flex items-center justify-center h-screen">
    <!-- Page Content -->
    <main>
        ...
        setInterval(() => {
            ...
            <!-- Company Logo -->
            <img src="https://placehold.co/150x150" alt="OneForAll Logo"
