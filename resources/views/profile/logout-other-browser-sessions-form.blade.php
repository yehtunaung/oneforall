        ...
        @if (count($this->sessions) > 0)
            ...
            <div class="mt-5">
                <div class="fd-lex align-items-center mt-4">
                    <x-admin.inputs.button-danger class="btn btn-primary" wire:click="confirmLogout"
            ...
            <x-admin.modal.modal-dialog wire:model="confirmingLogout">
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-4" x-data="{}"
                        ...
                        <x-admin.inputs.input type="password" class="mt-1 block w-3/4" autocomplete="current-password"
                            placeholder="{{ __('Password') }}" x-ref="password" wire:model.defer="password"
                            wire:keydown.enter="logoutOtherBrowserSessions" />

                        <x-admin.inputs.input-error for="password" class="mt-2" />
                    </div>
                </x-slot>

                <x-slot name="footer">
                    <x-admin.inputs.button-outlined wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                        {{ __('Cancel') }}
                    </x-inputs.button-outlined>

                    <x-admin.inputs.button-secondary class="ml-3" wire:click="logoutOtherBrowserSessions"
